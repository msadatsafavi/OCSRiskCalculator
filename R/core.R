...
{
  "The Oral Corticosteroid Risk Calculator (“Calculator”) is a web-based tool that provides an estimate of the long-term risk of exposure to oral corticosteroids for patients with asthma. The Calculator was developed by NAPTIA Consultation, with financial support from GlaxoSmithKline. You (the “End User”) is granted access to use the Calculator only on the condition that the End User agrees to the terms of use set forth below.
